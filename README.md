# fabulaUltimaOdyssey System

![Foundry v11](https://img.shields.io/badge/foundry-v11-green)

This system is a fabulaUltimaOdyssey system that you can use as a starting point for building your own custom systems. It's similar to Simple World-building, but has examples of creating attributes in code rather than dynamically through the UI.

## Usage

Before installing this system, you should rename any files that have `fabulaUltimaOdyssey` in their filename to use whatever machine-safe name your system needs, such as `adnd2e` if you were building a system for 2nd edition Advanced Dungeons & Dragons. In addition, you should search through the files for `fabulaUltimaOdyssey` and `fabulaUltimaOdyssey` and do the same for those, replacing them with appropriate names for your system.
...
Head over to the [Vue3fabulaUltimaOdyssey System](https://gitlab.com/asacolips-projects/foundry-mods/vue3fabulaUltimaOdyssey) repo if you're interested in using Vue!
...
![image](http://mattsmith.in/images/fabulaUltimaOdyssey.png)
