...
class _mergeObjectConfig {
    constructor() {
        this.insertKeys = true;
        this.insertValues = true;
        this.overwrite = true;
        this.recurse = true;
        this.inplace = true;
        this.enforceTypes = false;
        this.performDeletions = false;
    }
}
/**
...
export class fabulaUltimaOdysseyHeroSheet extends ActorSheet {
    ...
    _prepareCharacterData(context) {
        ...
        for (let [k, v] of Object.entries(context.system.abilities)) {
            v.label = (_a = game.i18n.localize(CONFIG.fabulaUltimaOdyssey.abilities[k])) !== null && _a !== void 0 ? _a : k;
        }
    }
    /**
     * Organize and classify Items for Character sheets.
